...
export function KpiCard({ label, value, trend, helper }: KpiCardProps) {
  return (
    <div className="min-h-36 rounded-2xl border border-slate-200/90 bg-white/90 p-4 shadow-[0_6px_20px_rgb(15_23_42/6%)] backdrop-blur-[1px] transition duration-200 hover:-translate-y-0.5 hover:shadow-[0_14px_26px_rgb(15_23_42/10%)]">
